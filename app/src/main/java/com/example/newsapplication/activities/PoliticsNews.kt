...
class PoliticsNews : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Politics url
        var urlString = "http://api.datanews.io/v1/news?q=politics&sortBy=date&apiKey=06qmzxf874s9m7dmuiajxv40e"

        //set the title for the activity
        val text = findViewById<View>(R.id.categories_title) as TextView
        text.setText(R.string.politics)
